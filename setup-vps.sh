...
echo "   cd /var/www"
echo "   git clone https://github.com/VOTRE-USERNAME/crm-leads-papa.git"
echo ""
echo "2. Créer le fichier .env dans backend:"
echo "   cd /var/www/crm-leads-papa/backend"
echo "   nano .env"
echo ""
echo "   Contenu du .env:"
echo "   PORT=5001"
...
echo ""
echo "3. Copier la configuration Nginx:"
echo "   cp /var/www/crm-leads-papa/nginx.conf /etc/nginx/sites-available/crm"
echo "   ln -s /etc/nginx/sites-available/crm /etc/nginx/sites-enabled/"
echo "   nginx -t"
echo "   systemctl restart nginx"
echo ""
echo "4. Lancer le premier déploiement:"
echo "   cd /var/www/crm-leads-papa"
echo "   ./deploy.sh"
echo ""
